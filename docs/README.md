...
- Removed inactive authentication and persistence scaffolding so the repository reflects the shipped product.
...
- Authentication and persistence are intentionally outside the current product scope.
